...
uploadFile() {
  ...
  if (this.state.outputData) {
    ...
    axios
      .get("https://u511sgbize.execute-api.us-east-2.amazonaws.com/putsignedurl?filetype="+filetypeName[1]+"&contenttype="+filetype.type)
      .then((res) => {
...
downloadFile() {
  ...
  if (this.state.outputData) {
    axios
      .get("https://u511sgbize.execute-api.us-east-2.amazonaws.com/getsignedurl?fileid="+this.state.uuid+"&user="+this.state.username)
      .then((res) => {
        putFileUrl = res.data.url;
...
checkLogin() {
  ...
  axios
      .post("https://rld4sylysa.execute-api.us-east-2.amazonaws.com/lambdaAuthLogin", data)
      .then((res) => {
        console.log(res.data);
        this.setState({outputData: true});
        if(this.state.outputData) {
